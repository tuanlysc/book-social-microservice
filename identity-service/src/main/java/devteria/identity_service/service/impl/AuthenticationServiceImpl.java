...
//    }
    ...
    private SignedJWT verifyToken(String token, boolean isRefresh) throws ParseException, JOSEException {
        ...
        // kiem tra chu ki jwt co khop voi voi khoa bi mat duoc them vao hay khong
        var verified = signedJWT.verify(verifier);

        if (!(verified && expiry.after(new Date()))) throw new AppException(ErrorCode.UNAUTHENTICATED);
